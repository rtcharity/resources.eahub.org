...
When we are deciding whether to impact invest, we must also consider the opportunity cost of impact investing. In the same way, if we want to make a profit, we wouldn’t compare the return on our investment to what we would have got _if we had done nothing_. Instead, we would compare our ROI to what we could have done otherwise with the money: if I chose an investment with a 3% return, but another available investment had an 8% return, then I would have made a mistake. The same is true if our aim is to have social impact.
