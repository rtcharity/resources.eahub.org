...
An alias is like a “nickname” for email. For example, we can make [info@example.com](info@example.com) be an alias that passes everything it receives to [crystal@example.com](crystal@example.com). This is a very powerful way to have more than one address without actually having more than one mailbox! 
...
If your name is Sally and you are in charge of donations at EA North Pole, and we tell you that we have created a mailbox for you at [sally@eanorthpole.com](sally@eanorthpole.com) as well as an alias [donations@eanorthpole.com](donations@eanorthpole.com), you will:
Use these steps to set up [sally@eanorthpole.com](sally@eanorthpole.com)
Go to webmail and change the password for [donations@eanorthpole.com](donations@eanorthpole.com) 
Use these steps to set up [donations@eanorthpole.com](donations@eanorthpole.com) so that you can send from that address
...
**Step 4**
In the popup, type in your LEAN email address (eg. _<your-name>@<your-domain>_):
...
If you have any trouble with the above steps, feel free to contact [tech@rtcharity.org](tech@rtcharity.org).
...
Port: 587
Username: the alias email address (eg. [boss@northpole.com](boss@northpole.com), not your main mailbox)
Password: the password for that address (eg. the password for [boss@northpole.com](boss@northpole.com), not the password for your main mailbox)
